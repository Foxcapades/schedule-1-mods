namespace Fxcpds {
  public static class Item {
    ...
    public const string CocaSeed             = "cocaseed";
    public const string ExtraLongLifeSoil    = "extralonglifesoil";
    public const string Fertilizer           = "fertilizer";
    public const string GranddaddyPurpleSeed = "granddaddypurpleseed";
    public const string GreenCrackSeed       = "greencrackseed";
    ...
    public const string LongLifeSoil         = "longlifesoil";
    public const string M1911                = "m1911";
    ...
    public const string OGKushSeed           = "ogkushseed";
    ...
    public const string SourDieselSeed       = "sourdieselseed";
